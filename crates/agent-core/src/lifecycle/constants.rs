...
pub(super) const ISOLATION_FAILSAFE_CHECK_INTERVAL_SECS: i64 = 60;
pub(super) const MEMORY_PRESSURE_CHECK_INTERVAL_TICKS: u64 = 10;
pub(super) const DISK_CHECK_INTERVAL_SECS: i64 = 60;
pub(super) const COMPLIANCE_ALERT_STATE_LIMIT: usize = 1024;
pub(super) const COMPLIANCE_GRACE_STATE_LIMIT: usize = 1024;
pub(super) const ACTIVE_CAMPAIGN_IOC_LIMIT: usize = 65536;
