...
fn dlp_detail_from_payload(
    ...
    Some(pb::telemetry_event::Detail::DlpDetection(
        pb::DlpDetectionEvent {
            ...
            bundle_version: root
                .get("dlp")
                .and_then(|v| v.get("bundle_version"))
                .and_then(|v| v.as_str())
                .unwrap_or_default()
                .to_string(),
            rule_id: detection
            ...
            content_sha256: root
                ...
                .unwrap_or_default()
                .to_string(),
            redacted_evidence: detection
                .get("redacted_evidence")
                .and_then(|v| v.as_str())
                .unwrap_or("[REDACTED]")
                .to_string(),
        },
