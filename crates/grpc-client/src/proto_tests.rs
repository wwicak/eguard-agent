...
fn telemetry_contract_includes_batch_event_ack_enums_and_detail() {
    assert_contains_all(
        ...
        &[
            ...
            "string mac",
            "string ip_address",
            "int64 collected_at_unix",
            "map<string, string> attributes",
            "message InventoryAck",
            "string status",
            "int32 next_report_override_secs",
...
fn command_contract_includes_command_types_and_parameter_messages() {
    assert_contains_all(
        ...
        &[
            ...
            "repeated string allow_server_ips",
            "message ScanParams",
            ...
            "message DeviceActionParams",
            "bool force",
            "string reason",
            "message LocateParams",
            "bool high_accuracy",
            "message AppParams",
            "string package_name",
            "string version",
