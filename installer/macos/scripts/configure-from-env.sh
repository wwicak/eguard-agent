...
GRPC_PORT="$(extract_port_from_server "$SERVER_ADDR")"
if ! is_valid_port "$GRPC_PORT"; then
    GRPC_PORT="50053"
fi

SERVER_HOST="$(extract_host_from_server "$SERVER_ADDR")"
